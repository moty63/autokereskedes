...
const autok = [
  ...
  new Auto('https://img.hasznaltautocdn.com/640x480/21556117/8180054.jpg', 'Tesla Model S 85', 8000000, 370, 0, 2014, 116000),
  ...
  new Auto('https://img.hasznaltautocdn.com/640x480/21655817/9272365.jpg', 'Opel Astra H', 1380000, 110, 1686, 2008, 325000),
  new Auto('https://img.hasznaltautocdn.com/640x480/21593852/8587846.jpg', 'Hyundai I30', 5000000, 185, 1600, 2016, 23000),
  new Auto('https://img.hasznaltautocdn.com/640x480/21599111/8648839.jpg', 'KIA Soul 1.6 GDI EX', 5600000, 1600, 132, 2017, 110000),
...
function megjelenit(autok) {
  ...
  autok.forEach(auto => {
      ...
      card.innerHTML = `
          ...
          <h1>${auto.ar} Ft</h1>
          <p class="title">Teljesítmény: ${auto.teljesitmeny} LE</p>
          <p class="title">Motortérfogat: ${auto.motor} cm³</p>
          <p class="title">Évjárat: ${auto.ev}</p>
